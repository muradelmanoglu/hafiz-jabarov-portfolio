        ...
        <div className="card mb-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="date" value={editing.endDate || ''} onChange={(e) => setEditing({ ...editing, endDate: e.target.value })} className="admin-input" disabled={editing.current} />
            </div>
            <div>
        ...
        {experiences.map((exp) => (
          <div key={exp.id} className="card flex items-start justify-between gap-4">
            ...
            <div className="flex gap-2 shrink-0">
              <button onClick={() => { setEditing({ ...exp }); setEditingId(exp.id) }} className="text-gray-500 hover:text-white">
                <Pencil size={16} />
              </button>
